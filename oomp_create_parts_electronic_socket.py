...
def load_parts(**kwargs):
    ...
    #dangerous prototypes raspberry pi pico
    ...
    part_details["size"] = ["2_54_mm"]
    part_details["color"] = [""]
    part_details["description_main"] = "20_pin"
    part_details["description_extra"] = ["through_hole"]
    part_details["manufacturer"] = "dangerous_prototypes"
    part_details["part_number"] = ["raspberry_pi_pico_side_a","raspberry_pi_pico_side_b"]
    part_details["kicad_reference"] = "CONN"
    #add the part to the list of parts
    parts.append(part_details)
